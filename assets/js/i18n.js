...
(function (global) {
  ...
  const dict = {
    en: {
      ...
      'hero.sub': 'Drilling equipment, valves, PPE and pumps from verified suppliers.',
      'hero.cta': 'Browse catalog',
      'hero.rfq': 'Create RFQ',
      'flash.banner': '🛢️ Oil & Gas B2B marketplace · Multi-currency · RFQ and catalog',
    ...
    ru: {
      ...
      'hero.sub': 'Буровое оборудование, арматура, СИЗ и насосы от проверенных поставщиков.',
